...
*   **IDE Backend (`/ide/backend`):** C++. Responsible for parsing code, generating C++ based on UI events, and invoking the CMake build system. Communicates with Electron.
...
│   └── backend/     # Code generation, parsing, system interaction
